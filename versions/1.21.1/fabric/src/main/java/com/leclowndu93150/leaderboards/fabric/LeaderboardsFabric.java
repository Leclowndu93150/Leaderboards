...
public class LeaderboardsFabric implements ModInitializer {
    ...
    public void onInitialize() {
        PayloadTypeRegistry.playC2S().register(RequestLeaderboardListPacket.TYPE, RequestLeaderboardListPacket.STREAM_CODEC);
        PayloadTypeRegistry.playC2S().register(RequestLeaderboardPacket.TYPE, RequestLeaderboardPacket.STREAM_CODEC);
        PayloadTypeRegistry.playS2C().register(LeaderboardListResponsePacket.TYPE, LeaderboardListResponsePacket.STREAM_CODEC);
        PayloadTypeRegistry.playS2C().register(LeaderboardResponsePacket.TYPE, LeaderboardResponsePacket.STREAM_CODEC);
